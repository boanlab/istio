...
BEGIN {
    ...
    require '/home/hochacha/openssl_test/openssl-3.0.8/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/home/hochacha/openssl_test/openssl-3.0.8/test/fips-and-base.cnf';
    shift;
